...
class AnalyseController extends Controller
{
    /**
     * @Rest\View()
     * @Rest\Get("users/{id}/consultations/{consultation}/analyses")
     */
     ...
     * @Rest\Post("users/{id}/consultations/{consultation}/analyses")
     */
    ...
    /**
     * @Rest\View()
     * @Rest\Patch("users/{id}/consultations/{consultation}/analyses/{analyse}")
     */
     ...
     * @Rest\Delete("users/{id}/consultations/{consultation}/analyses/{analyse}")
     */
