...
class MedicamentController extends Controller
{
    /**
     * @Rest\View()
     * @Rest\Get("users/{id}/consultations/{consultation}/medicaments")
     */
     ...
     * @Rest\Post("users/{id}/consultations/{consultation}/medicaments")
     */
    ...
    /**
     * @Rest\View()
     * @Rest\Patch("users/{id}/consultations/{consultation}/medicaments/{medicament}")
     */
     ...
     * @Rest\Delete("users/{id}/consultations/{consultation}/medicaments/{medicament}")
     */
