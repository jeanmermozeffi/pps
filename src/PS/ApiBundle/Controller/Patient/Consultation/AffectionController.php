...
class AffectionController extends Controller
{
    /**
     * @Rest\View()
     * @Rest\Get("/patients/{id}/consultations/{consultation}/affections")
     */
     ...
     * @Rest\Post("/patients/{id}/consultations/{consultation}/affections")
     */
    ...
    /**
     * @Rest\View()
     * @Rest\Patch("/patients/{id}/consultations/{consultation}/affections/{affection}")
     */
     ...
     * @Rest\Delete("/patients/{id}/consultations/{consultation}/affections/{afection}")
     */
