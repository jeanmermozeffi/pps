...
use PS\GestionBundle\Form\FaqType;
...
class FaqController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        return $this->render('GestionBundle:Faq:index.html.twig', ['faqs' => $faqs]);
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('GestionBundle:Faq:new.html.twig', [
            'faq' => $faq,
    ...
    public function showAction(Faq $faq)
    {
        ...
        return $this->render('GestionBundle:Faq:show.html.twig', [
            'faq' => $faq,
        ]);
    }
    ...
    public function editAction(Request $request, Faq $faq)
    {
        ...
        return $this->render('GestionBundle:Faq:edit.html.twig', [
            'faq'   => $faq,
    ...
    public function deleteAction(Request $request, Faq $faq)
    {
        ...
        return $this->render('GestionBundle:Faq:delete.html.twig', ['form' => $form->createView(), 'faq' => $faq]);
    }
