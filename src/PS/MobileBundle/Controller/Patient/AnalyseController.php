...
class AnalyseController extends Controller
{
    ...
    /**
     * @Rest\View(serializerGroups={"consultation", "specialite", "medecin", "personne", "hopital", "info-hopital", "pays", "consultation-analyse"})
     ...
     */
    public function getAnalysesAction(Request $request, ParamFetcherInterface $paramFetcher)
    {
        ...
        if ($consultation) {
            ...
            $maxPages = ceil(count($analyses) / $limit);
            ...
            return ['maxPages' => $maxPages, 'data' => $analyses->slice($offset, $limit)];
        }
