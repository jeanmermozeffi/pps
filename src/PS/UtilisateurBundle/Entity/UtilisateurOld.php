...
use PS\GestionBundle\Entity\PassContact;
 ...
 * })
 */
class UtilisateurOld extends BaseUser implements EquatableInterface
{
     ...
     * @Groups({"user"})
     * @Expose
     * @GRID\Column( title="Rôles", type="array", operatorsVisible=false, sortable=false, filter="select", selectFrom="values", values={"ROLE_SUPER_ADMIN":"Super Administrateur", "ROLE_ADMIN": "Administrateur", "ROLE_CUSTOMER":"Patient", "ROLE_MEDECIN": "Medecin", "ROLE_INFIRMIER": "Infirmier", "ROLE_PHARMACIE": "Pharmacien", "ROLE_RECEPTION": "Réceptionniste", "ROLE_ADMIN_LOCAL": "Admin Local", "ROLE_ADMIN_CORPORATE": "Admin Du groupe médical", "ROLE_ADMIN_SUP": "Admin Suppléant"})
     */
    protected $roles;
     ...
     * @Expose
     * @var string
     * @GRID\Column(title="Pseudo", operatorsVisible=false)
     * @Assert\NotBlank()
     ...
     * @Expose
     * @var string
     * @GRID\Column(title="Email", operatorsVisible=false)
     * @Groups({"user"})
     */
    protected $email;
