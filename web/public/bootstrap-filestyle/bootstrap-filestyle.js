...
(function($) {
	...
	Filestyle.prototype = {
		...
		constructor : function() {
            ...
            if (_self.options.fileUrl) {
                btn += '<a href="' + _self.options.fileUrl + '" target="_blank" class="btn btn-primary" title="Voir le fichier"><span class="fa fa-file-o"></span></a>';
            } 
